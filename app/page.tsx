        ...
        <div className="flex flex-col space-y-4 p-6 rounded-2xl bg-white/20 dark:bg-gray-800/20 backdrop-blur-xl border border-white/20 dark:border-gray-700/20">
          ...
          <div className="flex items-center space-x-6 pt-4 border-t border-white/10 dark:border-gray-700/10">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-sm text-muted-foreground/80">Revenue Up 20.1%</span>
            </div>
            <div className="flex items-center space-x-2">
              <div className="h-2 w-2 rounded-full bg-blue-500" />
              <span className="text-sm text-muted-foreground/80">2,350 Active Users</span>
            </div>
            <div className="flex items-center space-x-2">
              <div className="h-2 w-2 rounded-full bg-yellow-500" />
              <span className="text-sm text-muted-foreground/80">12 Pending Invoices</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="grid gap-8 md:grid-cols-2">
        <Card className="bg-white/20 dark:bg-gray-800/20 backdrop-blur-xl border border-white/20 dark:border-gray-700/20">
          <CardHeader>
            <CardTitle className="flex items-center justify-between">
              ...
              <div className="flex items-center space-x-2">
                <Button variant="outline" size="sm" className="bg-white/10 dark:bg-gray-800/10 border-white/10 dark:border-gray-700/10">
                  <Calendar className="h-4 w-4 mr-2" />
                  This Month
                </Button>
              </div>
            ...
            <CardDescription>
              Track your revenue growth and trends
            </CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card className="bg-white/20 dark:bg-gray-800/20 backdrop-blur-xl border border-white/20 dark:border-gray-700/20">
          <CardHeader>
            ...
            <CardDescription>
              Analyze your expense categories
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="h-[300px]">
            ...
            <div className="flex items-center space-x-2">
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-9 bg-white/20 dark:bg-gray-800/20 backdrop-blur-xl border-white/10 dark:border-gray-700/10"
                />
              </div>
              <Button variant="outline" size="sm" className="bg-white/10 dark:bg-gray-800/10 border-white/10 dark:border-gray-700/10">
                <Filter className="h-4 w-4 mr-2" />
              ...
              >
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground/80">{transaction.date}</p>
                  </div>
                </div>
